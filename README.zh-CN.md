...
| | 能不能跑 | 实测 |
|---|---|---|
| **N 卡 12 GB 及以上**（RTX 3080 Ti、4070、4090……） | 能，全画质 | 4090：62 ms/帧、显存峰值 11 GB；3080 Ti：83 ms/帧 |
| **N 卡 8 GB**（RTX 3070、4060……） | 能——工具自动切到 `--input-size 364` | 显存 3 GB、3080 Ti 上 34 ms/帧；深度图略软 |
