...
**ComfyUI.** Install [ComfyUI-ReShot](https://github.com/maosika-ai/ComfyUI-ReShot) and drop the _ReShot Depth Video_ node between Load Video and your model — no command line at all.
